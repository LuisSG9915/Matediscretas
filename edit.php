...
include("conexion.php");
    ...
    if(isset($_GET["id"])){
        $id= $_GET["id"];
        $query="SELECT * FROM crearactividad";
...
<body>
  ...
  <form method="post" <?php echo $_SERVER['PHP_SELF'] ?> enctype="multipart/form-data">
      ...
      <div class="container">
        <div class="row" style="">
          <div class="col-md-3 d-flex align-items-start justify-content-start flex-row flex-grow-1" style=""><a
              class="btn btn-primary" href="Actividades-profe.php">Regresar<br></a></div>
          <div class="col-md-8    offset-md-1" style="">
            <h1 class="text-primary" style="">&nbsp; &nbsp; &nbsp; Modificar actividad</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="pt-4" style="">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group"><label></label>
              <input type="text" name="unidad_Actividad" class="form-control w-100 form-control-sm"
              value="<?php echo $unidad;?>"></div>
          </div>
        </div>
      </div>
      <div class="container">
    ...
    <input name="fichero" class="btn btn-primary" type="file" size="150" maxlength="150" value="<?php echo $archivo;?>">  
